...
- `templates/`
- `scripts/`
- optional `TEAM_RULES.md` or `docs/team-rules.md`

Define branch strategy, PR rules, review owners, test commands, formatter/linter commands, security rules, issue tracking, deployment ownership, and rollback process.
