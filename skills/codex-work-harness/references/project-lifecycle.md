...
Planning: split features into MVP, later, and excluded. For outsourcing, define acceptance criteria.

Design: define screens, data flow, API flow, and simple file structure.
